...
- `fiddler-utils` installed from the `feature/rbac-automation` branch (until
  the RBAC PR merges and a tagged release is cut)
...
- `prune_extra_project_roles` only operates on projects mentioned in the
  spec — never org-wide.
- See [fiddler-utils PR #20](https://github.com/fiddler-labs/fiddler-utils/pull/20)
  for the full RBAC subpackage feature description.
